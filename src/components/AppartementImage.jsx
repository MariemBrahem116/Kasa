...
import "./AppartementImage.scss"

function AppartementImage(props) {
  ...
  return (
    ...
    {
      photos.map((photo,i) => (
        <img key={photo} src= {photo} alt="ImageAppartement" className={getClassName(i)}></img>
      ))
    }
...
export default AppartementImage